      ...
      <div className="relative">
        ...
        {photoSections.length > 1 && (
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:shadow-xl transition-shadow duration-300"
            aria-label="Next"
          >
            <svg
