...
const PROJECT_TITLES = [
  ...
  'Energy',
  'Lyra',
  'Evolution of My Embedded Systems',
  'Vibes',
  'Good OT Practice',
  'Foster',
  'Corner',
...
export function Hero() {
  ...
  const translations = {
    EN: {
      ...
      description: 'I\'m Nick. I figure out what\'s worth building and erase the gap between deciding, prototyping, and shipping. I care about solving the right problems and obsess over well‑designed products, from software to hardware. I previously built a venture‑backed startup. Click ',
